...
# Singularityイメージを実行
singularity exec test-refactoring-analysis.sif java  --add-opens java.base/java.lang=ALL-UNNAMED -jar /usr/work/collect-metrics-for-refactoring.jar $SLURM_ARRAY_TASK_ID