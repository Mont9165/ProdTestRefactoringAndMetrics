package jp.ac.kyushu.ait.posl.modules.refactoring;
...
public class TestRefactoringMiner {
    ...
    public void testAddParameter2(){
        ...
        Assert.assertEquals("Add Parameter", refactoringResults.get(1).getRefactoringType().getDisplayName());
        Assert.assertEquals("Remove Attribute Modifier", refactoringResults.get(0).getRefactoringType().getDisplayName());
    ...
    public void testChangeFieldType(){
        ...
        List<Refactoring> refactoringResults = RefactoringMinerController.getRefactoringInstanceAtCommit(gitX.getRepo(), commitId);
        Assert.assertEquals(2, refactoringResults.size());
        Assert.assertEquals("Change Attribute Type", refactoringResults.get(0).getRefactoringType().getDisplayName());
        Assert.assertEquals("Change Return Type", refactoringResults.get(1).getRefactoringType().getDisplayName());
    }
    @Test
    ...
    public void testPullUp(){
        ...
        GitController gitX = new GitController(sm, "/x/");
        List<Refactoring> refactoringResults = RefactoringMinerController.getRefactoringInstanceAtCommit(gitX.getRepo(), commitId);
//        for(int i = 0;i<refactoringResults.size();i++){
//            System.out.println(refactoringResults.get(i).getRefactoringType().getDisplayName());
//            System.out.println("   "+refactoringResults.get(i).leftSide().toString());
//        }
        Assert.assertEquals(10, refactoringResults.size());
        ...
        Assert.assertEquals("Change Variable Type", refactoringResults.get(2).getRefactoringType().getDisplayName());
        Assert.assertEquals("Move Method", refactoringResults.get(3).getRefactoringType().getDisplayName());
        Assert.assertEquals("Change Variable Type", refactoringResults.get(4).getRefactoringType().getDisplayName());
        Assert.assertEquals("Move Method", refactoringResults.get(5).getRefactoringType().getDisplayName());
        Assert.assertEquals("Change Variable Type", refactoringResults.get(6).getRefactoringType().getDisplayName());
        Assert.assertEquals("Move Method", refactoringResults.get(7).getRefactoringType().getDisplayName());
        Assert.assertEquals("Change Variable Type", refactoringResults.get(8).getRefactoringType().getDisplayName());
        Assert.assertEquals("Move Method", refactoringResults.get(9).getRefactoringType().getDisplayName());
